...
<template>
  <div class="min-h-screen py-4 sm:py-8 lg:py-12">
    ...
    <div class="space-y-4 sm:space-y-6 lg:space-y-8">
        ...
        <div v-if="blockchain.current" class="backdrop-blur-xl bg-white/95 dark:bg-white/5 rounded-2xl sm:rounded-3xl border border-gray-200 dark:border-white/10 p-4 sm:p-6 lg:p-8 shadow-lg dark:shadow-2xl">
            <div class="flex flex-col sm:flex-row sm:justify-between sm:items-start gap-4">
              <!-- Main Content -->
              <div class="flex-1">
                <div class="flex items-center gap-3 sm:gap-4 mb-3 sm:mb-4">
                  <img src="/logo.svg" class="w-8 h-8 sm:w-10 sm:h-10 lg:w-12 lg:h-12" alt="Flora Logo" />
                  <h1 class="text-2xl sm:text-3xl lg:text-5xl font-bold bg-gradient-to-r from-purple-400 via-blue-400 to-indigo-400 bg-clip-text text-transparent">
                    {{ blockchain.current?.prettyName || 'Flora' }}
                  </h1>
                </div>
                <p class="text-sm sm:text-base text-gray-600 dark:text-blue-200/70 ml-11 sm:ml-14 lg:ml-16">Explore blocks, transactions, and network statistics</p>
              </div>
              ...
              <div class="flex gap-3 sm:gap-4 items-center justify-end sm:justify-start">
                ...
                <a 
                  ...
                  target="_blank"
                  class="group relative backdrop-blur-xl bg-gradient-to-br from-blue-500/20 to-indigo-500/20 hover:from-blue-500/30 hover:to-indigo-500/30 rounded-full border-2 border-blue-500/30 transition-all duration-300 transform hover:scale-105 w-10 h-10 sm:w-12 sm:h-12 lg:w-16 lg:h-16 flex items-center justify-center"
        ...
        <!-- Top Statistics Grid - Mobile Optimized -->
        <div class="grid grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-4 lg:gap-5">
        <!-- Block Height -->
        <div class="backdrop-blur-xl bg-white/95 dark:bg-white/5 rounded-2xl sm:rounded-3xl border border-gray-200 dark:border-white/10 p-3 sm:p-4 lg:p-6 shadow-lg dark:shadow-none relative overflow-hidden">
          <div class="absolute top-0 right-0 w-20 sm:w-24 lg:w-32 h-20 sm:h-24 lg:h-32 bg-gradient-to-br from-amber-500/10 to-orange-500/10 rounded-full blur-3xl transform translate-x-8 -translate-y-8"></div>
          <div class="relative">
        ...
        <!-- Total Supply -->
        <div class="backdrop-blur-xl bg-white/95 dark:bg-white/5 rounded-2xl sm:rounded-3xl border border-gray-200 dark:border-white/10 p-3 sm:p-4 lg:p-6 shadow-lg dark:shadow-none relative overflow-hidden">
          <div class="absolute top-0 right-0 w-20 sm:w-24 lg:w-32 h-20 sm:h-24 lg:h-32 bg-gradient-to-br from-purple-500/10 to-blue-500/10 rounded-full blur-3xl transform translate-x-8 -translate-y-8"></div>
          <div class="relative">
            <div class="flex items-center justify-between mb-1 sm:mb-2">
            ...
            <div class="text-base sm:text-xl lg:text-2xl font-bold bg-gradient-to-r from-purple-600 to-blue-600 dark:from-purple-400 dark:to-blue-400 bg-clip-text text-transparent truncate">{{ floraStats.totalSupply }}</div>
          </div>
        </div>
        
        <!-- Bonded Tokens -->
        <div class="backdrop-blur-xl bg-white/95 dark:bg-white/5 rounded-2xl sm:rounded-3xl border border-gray-200 dark:border-white/10 p-3 sm:p-4 lg:p-6 shadow-lg dark:shadow-none relative overflow-hidden">
          <div class="absolute top-0 right-0 w-20 sm:w-24 lg:w-32 h-20 sm:h-24 lg:h-32 bg-gradient-to-br from-blue-500/10 to-cyan-500/10 rounded-full blur-3xl transform translate-x-8 -translate-y-8"></div>
          <div class="relative">
            <div class="flex items-center justify-between mb-1 sm:mb-2">
            ...
            <div class="text-base sm:text-xl lg:text-2xl font-bold bg-gradient-to-r from-blue-600 to-cyan-600 dark:from-blue-400 dark:to-cyan-400 bg-clip-text text-transparent truncate">{{ floraStats.bondedTokens }}</div>
          </div>
        </div>
        
        <!-- Community Pool -->
        <div class="backdrop-blur-xl bg-white/95 dark:bg-white/5 rounded-2xl sm:rounded-3xl border border-gray-200 dark:border-white/10 p-3 sm:p-4 lg:p-6 shadow-lg dark:shadow-none relative overflow-hidden">
          <div class="absolute top-0 right-0 w-20 sm:w-24 lg:w-32 h-20 sm:h-24 lg:h-32 bg-gradient-to-br from-green-500/10 to-emerald-500/10 rounded-full blur-3xl transform translate-x-8 -translate-y-8"></div>
          <div class="relative">
            <div class="flex items-center justify-between mb-1 sm:mb-2">
            ...
            <div class="text-base sm:text-xl lg:text-2xl font-bold bg-gradient-to-r from-green-600 to-emerald-600 dark:from-green-400 dark:to-emerald-400 bg-clip-text text-transparent truncate">{{ floraStats.communityPool }}</div>
          </div>
        </div>
        </div>
        ...
        <div class="lg:col-span-2 space-y-4 sm:space-y-5 lg:space-y-6">
          ...
          <div v-if="blockchain.supportModule('staking') || blockchain.supportModule('bank')" 
               class="backdrop-blur-xl bg-white/95 dark:bg-white/5 rounded-2xl sm:rounded-3xl border border-gray-200 dark:border-white/10 p-4 sm:p-5 lg:p-6 shadow-lg dark:shadow-none relative overflow-hidden">
          ...
          <!-- Active Proposals - Mobile Optimized -->
          <div v-if="blockchain.supportModule('governance')" 
               class="backdrop-blur-xl bg-white/95 dark:bg-white/5 rounded-2xl sm:rounded-3xl border border-gray-200 dark:border-white/10 overflow-hidden shadow-lg dark:shadow-none">
        ...
        <div class="space-y-4 sm:space-y-5 lg:space-y-6">
          ...
          <div v-if="walletStore.currentAddress" 
            ...
            <div class="p-4 sm:p-5 lg:p-6">
              <div class="space-y-3 sm:space-y-4 mb-4 sm:mb-5 lg:mb-6">
                <div class="bg-gray-50 dark:bg-white/5 backdrop-blur rounded-xl p-3 sm:p-4 border border-gray-200 dark:border-white/10">
              ...
              <div class="grid grid-cols-1 sm:grid-cols-3 gap-3 sm:gap-4">
                <button class="w-full backdrop-blur-md bg-blue-500/20 hover:bg-blue-500/30 text-blue-300 font-medium py-2.5 sm:py-3 px-3 sm:px-4 rounded-xl border border-blue-500/30 transition-all duration-200 text-sm sm:text-base"
                        @click="dialog.open('send', {})">
                  {{ $t('account.send') }}
                </button>
                <button class="w-full backdrop-blur-md bg-purple-500/20 hover:bg-purple-500/30 text-purple-300 font-medium py-2.5 sm:py-3 px-3 sm:px-4 rounded-xl border border-purple-500/30 transition-all duration-200 text-sm sm:text-base"
                        @click="dialog.open('delegate', {})">
                  {{ $t('account.delegate') }}
                </button>
                <button class="w-full backdrop-blur-md bg-cyan-500/20 hover:bg-cyan-500/30 text-cyan-300 font-medium py-2.5 sm:py-3 px-3 sm:px-4 rounded-xl border border-cyan-500/30 transition-all duration-200 text-sm sm:text-base"
          ...
          <!-- Application Version - Mobile Optimized -->
          <div class="backdrop-blur-xl bg-white/90 dark:bg-white/5 rounded-2xl sm:rounded-3xl border border-gray-200 dark:border-white/10 overflow-hidden shadow-lg dark:shadow-none">
            <div class="p-4 sm:p-5 lg:p-6 border-b border-gray-200 dark:border-white/10">
              <h2 class="text-lg sm:text-xl font-semibold text-gray-900 dark:text-white flex items-center gap-2">
          ...
          <!-- Deployment Version - Mobile Optimized -->
          <div v-if="versionInfo" class="backdrop-blur-xl bg-white/90 dark:bg-white/5 rounded-2xl sm:rounded-3xl border border-gray-200 dark:border-white/10 overflow-hidden shadow-lg dark:shadow-none">
